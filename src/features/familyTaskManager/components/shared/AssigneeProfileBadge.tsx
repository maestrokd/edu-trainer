...
export function AssigneeProfileBadge({ profile, profileColor, unknownLabel }: AssigneeProfileBadgeProps) {
  ...
  return (
    <span className="inline-flex max-w-full items-center gap-1 rounded-full border border-border bg-muted/60 py-0.5 pr-2 pl-0.5 text-xs font-medium text-foreground/80">
      <span
