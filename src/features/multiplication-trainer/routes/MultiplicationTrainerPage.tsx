      ...
      {state.screen === "setup" ? (
        <MultiplicationTrainerSetupScreen
          ...
          labels={{
            ...
            range: t("multiT.setup.range")!,
            rangeHint: t("multiT.setup.rangeHint"),
            ...
            exercises: t("multiT.setup.exercises"),
            mul: t("multiT.ex.mul"),
            div: t("multiT.ex.div"),
            timer: t("multiT.setup.timer")!,
            timerHint: t("multiT.setup.timerHint"),
            ...
            ariaMode: t("multiT.aria.mode"),
            ariaMul: t("multiT.aria.includeMul"),
            ariaDiv: t("multiT.aria.includeDiv"),
            ariaTimer: t("multiT.aria.timerMinutes"),
            ariaMaxExercises: t("multiT.aria.maxExercises"),
            moreInfo: (field) => t("multiT.aria.moreInfo", { field }),
          }}
        />
      ) : (
        <MultiplicationTrainerPlayScreen
          ...
          labels={{
            ...
            ariaAnswerField: t("multiT.aria.answerField"),
            ariaOption: (opt: number) => t("multiT.quiz.optionAria", { opt }),
            ariaCorrect: t("multiT.aria.correct"),
            ariaWrong: t("multiT.aria.wrong"),
